...
# Load monthly and convert DueDate
...
if page == "Dashboard":
    ...
    af=sorted(ARCHIVE_DIR.glob("*.csv"),reverse=True)
    sel=st.selectbox("Select Archive File",[f.name for f in af])
    if sel:
